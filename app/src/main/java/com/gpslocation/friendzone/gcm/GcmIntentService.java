...
public class GcmIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        switch (key) {
            ...
            default:
                ...
                String uid=intent.getStringExtra("unique");
                registerGCM(uid);
        }
     ...
     */
    private void registerGCM(String uid){
...
InstanceID instanceID=InstanceID.getInstance(this);
    ...
    private void sendRegistrationToServer(final String token,final String uid){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.GCMREG, new Response.Listener<String>() {
