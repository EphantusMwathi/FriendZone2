...
/**
 * Created by mwathi on 4/21/2016.
 */
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
   ...
   private Context mContext;
    ...
    public NotificationAdapter(Context mContext,ArrayList<Notification> notificationArrayList){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.message.setText(notification.getNotification());


        holder.timestamp.setText(getTimeStamp(notification.getCreated_at()));
    }
